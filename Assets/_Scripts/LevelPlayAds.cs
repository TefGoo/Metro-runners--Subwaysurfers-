...
public class LevelPlayAds : MonoBehaviour
{
    ...
    void Start()
    {
        IronSource.Agent.init("18ca6a805");
    ...
    {
        if (placement.getPlacementName() == "rewardedVideoPlacement")
        {
            SkinPanel skinPanel = FindObjectOfType<SkinPanel>();
            if (skinPanel != null)
            {
                skinPanel.OnSkinButtonPress();
            }
        }
